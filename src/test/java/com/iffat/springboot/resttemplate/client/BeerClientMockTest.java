...
import com.iffat.springboot.resttemplate.config.OAuthClientInterceptor;
import com.iffat.springboot.resttemplate.config.RestTemplateBuilderConfig;
...
public class BeerClientMockTest {
    ...
    public static class testConfig {
        ...
        @Bean
        OAuthClientInterceptor oAuthClientInterceptor(OAuth2AuthorizedClientManager oAuth2AuthorizedClientManager, ClientRegistrationRepository clientRegistrationRepository) {
